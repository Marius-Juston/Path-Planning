...
public class PointsPathTable extends PathTable<PointsPathGroup, PointAngleGroup> {
  ...
  public PointsPathTable(PointsPathGroup pathGroup) {
    ...
    pathTableContextMenu.getItems()
        .addAll(addPoint, removePoint, showPointsDetails, hidePointsDetails);
    ...
    initializeNumberColumn("X", "translatedX",
        cellEditEvent -> {
          ...
          pointAngleGroup.getPositionPoint().setCenterX(((
              cellEditEvent.getNewValue().doubleValue()) / Field.getInstance().SCALE.get()) + pointAngleGroup
              .getOriginPoint()
              .getPositionPoint()
              .getCenterX());
        }
    ...
    initializeNumberColumn("Angle", "degrees",
        cellEditEvent -> {
          ...
          pointAngleGroup
              ...
              .set(Math.toRadians(cellEditEvent.getNewValue().doubleValue()) + pointAngleGroup
                  .getOriginPoint()
